...
| 4.5 | Document check location in README/DECISIONS | `docs(r2): where workspace checks live and why` | [x] |
...
| 5.3 | UI: resolve immediate; notify status visible | `feat(r3): truthful resolve + notify status in UI` | [x] |
| 5.4 | Tests: outbox resolve and drain behavior | `test(r3): outbox resolve and drain behavior` | [x] |
| 5.5 | Name guarantee honestly in DECISIONS | `docs(r3): state notify delivery guarantee` | [x] |
...
| 6.2 | Load more UI with after=id | `feat(r4): queue load-more with after id` | [x] |
| 6.3 | Tests: no duplicate ids under churn | `test(r4): keyset pages stable under churn` | [x] |
| 6.4 | EXPLAIN ANALYZE + failure mode note | `docs(r4): explain analyze and pagination failure mode` | [x] |
...
| 7.5 | Document sweep + expiry decision | `docs(r5): sweep runner and resolve-after-expiry` | [x] |
...
| 8.2 | Finalize DECISIONS.md | `docs: finalize DECISIONS.md` | [x] |
| 8.3 | Finalize AI_USAGE.md | `docs: finalize AI_USAGE.md` | [x] |
